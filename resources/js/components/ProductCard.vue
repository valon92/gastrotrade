    ...
    <div class="p-6 relative">
      ...
      <div class="flex justify-between items-center">
        ...
        <div class="flex gap-2">
          ...
          <button 
            @click="addToCart"
            class="bg-primary-600 hover:bg-primary-700 text-white font-medium py-2 px-3 rounded-lg transition-colors duration-200 text-sm flex items-center justify-center"
